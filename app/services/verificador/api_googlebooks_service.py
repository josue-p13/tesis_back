...
from app.services.verificador.http_client import _get, GOOGLEBOOKS_BASE
from app.services.obtener.text_utils_service import _validar_resultado, _normalizar
